...
years_impl <- data.frame(Country = # Create a data frame with the years of implementation of infrastructures to use on the graphs 
                           c("Afghanistan", 
                             "Cambodia", 
                             "Colombia", 
                             "Costa Rica", 
...
years_post_impl <- data.frame(Country = # Create a data frame with the years of implementation of infrastructures to use on the graphs 
                           c("Afghanistan", 
                             "Cambodia", 
                             "Colombia", 
                             "Costa Rica", 
...
On the previous graph we see the sub-indicators scores for each country, in the year after they implemented a given peace infrastructure. We can see that **Afghanistan** and **Yemen** perform poorly in all dimensions of state fragility. 
